...
# | generally located in the top left corner of a keyboard, above the Tab key. If you don't have a backtick key, 
...
# | where N represents the length of the my_seq vector. In other words, we want a new vector (1, 2, 3, ...) that 
...
#  to contain 10 zeros, then 10 ones, then 10 twos. We can do this with the `each` argument. Try 
#  rep(c(0, 1, 2), each = 10).
rep(c(0, 1, 2), each= 10)
